...
/**
 * @description Check if method is available via Arpon
 * @returns {boolean}
 */
...
/**
 * @description Default mononow model
 * @returns {string} Default mononow model
 */
...
/**
 * Standard mononow devices
 * @deprecated
 * @returns {array} A list of standard devices
 */
export const STANDARD_Arpon_DEVICES = [MODELS.S920, MODELS.Q92, MODELS.V240M];
...
export function isStandardModel() {
  return _hasModelAtList(STANDARD_Arpon_DEVICES);
}
